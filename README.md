...
Just Download the project Use "npm i" for anguler then use "ng serve" command the forntend will up and running. I will also attach a db file soon for some startup data.
