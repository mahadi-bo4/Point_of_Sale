...
Just Download the project Use "npm i" for anguler then use "ng serve" command the forntend will up and running i've used angular15.1.2. I will also attach a db file soon for some startup data.
