...
Just Download the project Use "npm i" for anguler then use "ng serve" command the forntend will up and running i've used angular16. I will also attach a db file soon for some startup data.
